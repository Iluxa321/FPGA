...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "tb_port_bus_mem"
}
...
alias com {
  ...
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$RTLDIR/bus.sv"
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$RTLDIR/masterPort.sv"
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$RTLDIR/ram.v" 
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$RTLDIR/data_ram.sv"  
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$TBDIR/tb_port_bus_mem.sv"                                                                     
}
